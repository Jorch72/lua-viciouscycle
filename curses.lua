...
local function gettcod()
	...
	local function start()
		...
		local font = "fonts/Eunuch.png"
		--extended.aspect = widths[fontsize] / heights[fontsize]
		
		local renderer = tcod.TCOD_RENDERER_SDL
		os.setlocale("en_US.UTF-8", "all")
		tcod.TCOD_console_set_custom_font(font, (tcod.TCOD_FONT_TYPE_GREYSCALE + tcod.TCOD_FONT_LAYOUT_ASCII_INROW), 128, 512);
		tcod.TCOD_console_init_root(COLS, ROWS, termtitle, 0, renderer);
		tcod.TCOD_console_map_ascii_codes_to_font(0, 65535, 0, 0);
